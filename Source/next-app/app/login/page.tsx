...
export default function Home() {
  ...
  function LoginWithGoogle() {
    ...
    const link = `https://accounts.google.com/o/oauth2/auth?scope=https://www.googleapis.com/auth/userinfo.profile&response_type=code&state=${state}&redirect_uri=${window.location.origin}/googlelogin&client_id=${client_id}`;
